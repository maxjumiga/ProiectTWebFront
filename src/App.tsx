...
export default function App() {
  ...
  const [done, setDone] = useState(() => {
    return localStorage.getItem('onboarding') !== null;
  });
  ...
  const logout = () => {
    ...
    setDone(false);
    setStep(0);
    setData({ gender: null, age: null, heightCm: null, weightKg: null, goal: null });
  };

  if (done) return <Dashboard data={data} onLogout={logout} />;
